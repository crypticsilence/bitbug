...
#add_rule(name,type,desc,syntax,vars)
add_rule("feroxbuster","fuzz-dirfile","Feroxbuster general file/dirfuzzer","feroxbuster -u @@URL@@ --insecure ^^-w==WORDLIST^^","@@URL@@,^^WORDLIST^^")
add_rule("feroxbuster","fuzz-dirfile-proxy","Feroxbuster Proxied file/dirfuzzer","feroxbuster -u http://127.1 --insecure --proxy http://@@PROXY_URL@@:@@PROXY_PORT@@","@@PROXY_URL@@,@@PROXY_PORT@@")
add_rule("ffuf","fuzz-dirfile","FFUF general file/dirfuzzer","ffuf -u '@@URL@@/FUZZ' ^^-w==WORDLIST^^ ^^-H==HEADERS^^","@@URL@@,^^WORDLIST^^,^^HEADERS^^")
add_rule("ffuf","fuzz-dirfile-multiwordlist","FFUF multiple file/dirfuzzer","ffuf -u '@@URL@@' ^&-w==WORDLIST:VAR&^ ^^-H==HEADERS^^","@@URL@@,^&WORDLIST:VAR&^,^^HEADERS^^")
...
add_rule("nikto","web-enumeration","nikto web enumeration tool","nikto -h @@HOST@@ ^^^^","@@HOST@@,^^")
